...
echo "<center><h1>Lecture hall latest temperature values and heatmap</center></h1>";
...
$epoch=time()+19800-240;
$dt = new DateTime("@$epoch"); 
$experiment_start_time=$dt->format('Y-m-d H:i:s');
$epoch=strtotime($experiment_start_time);
...
$sql = "SELECT node_id,temperature,humidity FROM cooling.temperature_analysis WHERE room_name=\"".$room_name_in_table."\" and timestamp>\"".$experiment_start_time."\" and timestamp<\"".$experiment_start_time_plus_three."\"";
...
//   for (var j = 0; j < dataa[i].length; j++) {
	    ...
	    echo "<center><h2>Temperature values at time: ".$experiment_start_time."</h2></center>";

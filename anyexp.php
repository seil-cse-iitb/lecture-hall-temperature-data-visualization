...
echo "<center><h3><form action=\"anyexp.php\" method=\"post\">";
echo "Experiment Start time: <input type=\"datetime-local\" name=\"stime\" step=\"1\"><br><br>";
echo "Experiment End time: <input type=\"datetime-local\" name=\"etime\" step=\"1\"><br><br>";
...
$epch=strtotime($_POST['stime']);
$epch=$epch+19800;
$dt = new DateTime("@$epch"); 
$experiment_start_time=$dt->format('Y-m-d H:i:s');

$epch=strtotime($_POST['etime']);
$epch=$epch+19800;
$dt = new DateTime("@$epch"); 
...
// echo "<center><h1>Experiment-6</center></h1>";
// echo "<center><h1>For more details about experiment. Please visit <a href=\"https://docs.google.com/spreadsheets/d/1Lx4I1Mvt-_VzvpmUEJly60ekRtRD-eSg102IfrodjIM/edit#gid=0\" target=\"_blank\">this</a> link</center></h1>";

echo "<center><h3>Sensor nodes placement is given in below image</center></h3>";

echo "<img src=\"lh.jpg\" ><br><br><br>";
echo "<img src=\"rr.jpg\" >";
...
<input type='hidden' name='stime' value='<?php echo "$experiment_start_time";?>'/> 
<input type='hidden' name='etime' value='<?php echo "$experiment_end_time";?>'/> 
